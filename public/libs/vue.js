...
(function (global, factory) {
     ...
     * is in that map.
     */
    function makeMap(       // 返回判断一个字符串是否在map中的函数
        str,
        expectsLowerCase
    ) {
     ...
     */
    var isBuiltInTag = makeMap('slot,component', true); // vue内置tag
     ...
     */
    var camelizeRE = /-(\w)/g;
    var camelize = cached(function (str) {      // 将-连接的字符串转化为驼峰
   ...
   */
     ...
     */
    function normalizeInject(options, vm) {     // 标准化options.inject：inject为对象，inject的属性也是对象，属性的默认属性from为属性名
